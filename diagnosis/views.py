...
# Use os.environ to get the key from your local .env (which won't be on GitHub)
client = Groq(
...
def ask_doctor(request):
    ...
    try:
        ...
        # 2. Groq Client
        client = Groq(api_key=os.getenv("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"))
